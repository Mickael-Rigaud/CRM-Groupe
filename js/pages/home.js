  ...
  render(root) {
    const draw = () => {
      ...
      root.innerHTML = `
        ...
        <div class="card" style="display:flex;justify-content:space-between;align-items:center;gap:16px;flex-wrap:wrap;background:linear-gradient(115deg,var(--accent-ink),var(--accent));color:#fff;border:0">
          ...
          <a class="btn" href="#/today" style="background:#fff;color:var(--accent-ink)">Ouvrir ma journée →</a>
        </div>
